        ...
        <div className="flex flex-col items-center justify-center my-10 mx-5 p-5 bg-gray-300 rounded shadow-lg">
            <form onSubmit={handleSubmit} className="w-full max-w-sm">
                ...
                <div className="flex items-center mb-4">
                    <button type="button" onClick={decrement} className="bg-blue-400 text-black mx-2 px-3 rounded">-</button>
                    <p className="rounded bg-white border border-gray-400 text-black text-center w-12">{quantity}</p>
                    <button type="button" onClick={increment} className="bg-blue-400 text-black mx-2 px-3 rounded">+</button>
                </div>
